...
//
// 调度按 ScheduleKind(cron/fix_rate/fix_delay/delay/run_at/manual)+ ScheduleExpr 推算 NextRunTime。
type Job struct {
	...
	// —— 调度 ——
	ScheduleKind string     `gorm:"type:varchar(16)" json:"schedule_kind,omitempty"`  // cron | fix_rate | fix_delay | delay | run_at | manual
